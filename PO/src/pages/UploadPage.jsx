...
const UploadPage = () => {
  ...
  const fetchData = () => {
    axios.get('http://localhost:5000/fetch-purchases')
      .then(response => {
    ...
    style={{ 
      ...
      <main className="flex-grow flex flex-col items-center p-4 relative z-10">
        ...
        <div className="w-full max-w-7xl flex justify-center">
          <UploadBox onSuccess={handleSuccess} onError={handleError} />
        </div>
          ...
          <div className="mt-8 w-full max-w-5xl h-80 overflow-y-scroll border border-gray-700 p-4">
            ...
            <table className="w-full text-white border-separate border-spacing-2">
              <thead>
                ...
                <th className="border border-gray-600 p-2">Invoice Number</th>
                  <th className="border border-gray-600 p-2">Buy Date</th>
